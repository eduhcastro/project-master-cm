...
$CheckAccount = new $Init['CheckAccount'];
if (!isset($AddonsRoot->getParams("http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]")["token"])) header("Location: /home");
$Execute = $CheckAccount->handler($AddonsRoot->getParams("http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]")["token"]);
if (!$Execute[0]) header("Location: /home");
